...
public class Phonetic {
	private static int[] value = new int[] {-20319, -20317, -20304, -20295, -20292, -20283, -20265, -20257, -20242, -20230, -20051, -20036, -20032,  
	...
	private static String[] str = new String[] {"a", "ai", "an", "ang", "ao", "ba", "bai", "ban", "bang", "bao", "bei", "ben", "beng", "bi", "bian",  
	...
	public static String ToPhonetic(String str){
		...
		for(int i=value.length-1;i>=0;i--){
			if(value[i]<asc) return String.valueOf(Phonetic.str[i].charAt(0)).toUpperCase();
		}
		return "#";
	}
}
